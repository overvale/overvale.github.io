...
- Use version control
- Learn to code a little so you can make tools for yourself

Adopting these ways of working introduced me to the idea of putting each clause or idea of a sentence on a separate line. I got the idea from [Brandon Rhodes (by way of Brian W. Kernighan)](http://rhodesmill.org/brandon/2012/one-sentence-per-line/) and have been using it ever since. Here's how he explains it:
...
Splitting each clause of a sentence into separate lines more clearly highlights the structure of a sentence. Apparently, Buckminster Fuller called it "[Ventilated Prose](https://vanemden.wordpress.com/2009/01/01/ventilated-prose/)". The effect has been so profound that I now write by hand in this way. (There's even an [xkcd comic](https://www.xkcd.com/1285/) about it.)
